        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl bg-white p-8 md:p-12 rounded-2xl shadow-lg border border-border/50">
          ...
          <div className="prose lg:prose-lg max-w-none text-muted-foreground leading-relaxed">
            ...
            <div className="space-y-12">
              <div>
                <h3 className="text-2xl font-serif font-bold text-foreground mb-4">1. Business Information</h3>
              ...
              <div>
                <h3 className="text-2xl font-serif font-bold text-foreground mb-4">2. Information We Collect</h3>
              ...
              <div>
                <h3 className="text-2xl font-serif font-bold text-foreground mb-4">3. How We Collect Information</h3>
              ...
              <div>
                <h3 className="text-2xl font-serif font-bold text-foreground mb-4">4. How We Use Your Information</h3>
              ...
              <div>
                <h3 className="text-2xl font-serif font-bold text-foreground mb-4">5. Sharing of Information</h3>
              ...
              <div>
                <h3 className="text-2xl font-serif font-bold text-foreground mb-4">6. Cookies & Tracking Technologies</h3>
              ...
              <div>
                <h3 className="text-2xl font-serif font-bold text-foreground mb-4">7. Data Storage & Security</h3>
              ...
              <div>
                <h3 className="text-2xl font-serif font-bold text-foreground mb-4">8. Data Deletion Rights</h3>
              ...
              <div>
                <h3 className="text-2xl font-serif font-bold text-foreground mb-4">9. No User Accounts</h3>
              ...
              <div>
                <h3 className="text-2xl font-serif font-bold text-foreground mb-4">10. Third-Party Services</h3>
              ...
              <div>
                <h3 className="text-2xl font-serif font-bold text-foreground mb-4">11. Links to External Websites</h3>
              ...
              <div>
                <h3 className="text-2xl font-serif font-bold text-foreground mb-4">12. Local SEO Clause (for Noida & NCR Users)</h3>
              ...
              <div>
                <h3 className="text-2xl font-serif font-bold text-foreground mb-4">13. Updates to This Privacy Policy</h3>
              ...
              <div>
                <h3 className="text-2xl font-serif font-bold text-foreground mb-4">14. Contact for Privacy Matters</h3>
